  ...
  return (
    <div className='w-[100%]'>
      ...
      <div className='w-[100%] lg:w-[90%] mx-auto'>
        ...
        <ul>
          <li className='text-blue-900 flex items-center my-1'>
            <IoMdArrowDropright className='text-green-700 text-2xl' />
            <Link href='#'>শিক্ষা মন্ত্রণালয়</Link>
          </li>
          <li className='text-blue-900 flex items-center my-1'>
            <IoMdArrowDropright className='text-green-700 text-2xl' />
            <Link href='https://shed.gov.bd/'>মাধ্যমিক ও উচ্চ শিক্ষা বিভাগ</Link>
          </li>
          <li className='text-blue-900 flex items-center my-1'>
            <IoMdArrowDropright className='text-green-700 text-2xl' />
            <Link href='http://www.dsherangpur.gov.bd/'>মাধ্যমিক ও উচ্চশিক্ষা, রংপুর অঞ্চল</Link>
          </li>
          <li className='text-blue-900 flex items-center my-1'>
            <IoMdArrowDropright className='text-green-700 text-2xl' />
            <Link href='https://dinajpurboard.gov.bd/'>দিনাজপুর বোর্ড (ই-ফাইলিং, রেজিঃ, ফরম ফিলাপ)</Link>
          </li>
          <li className='text-blue-900 flex items-center my-1'>
            <IoMdArrowDropright className='text-green-700 text-2xl' />
            <Link href='https://dinajpureducationboard.gov.bd/'>দিনাজপুর বোর্ড (অফিসিয়াল সাইট, নোটিশ)</Link>
          </li>
          <li className='text-blue-900 flex items-center my-1'>
            <IoMdArrowDropright className='text-green-700 text-2xl' />
            <Link href='https://bteb.gov.bd/'>বাংলাদেশ কারিগরি শিক্ষা বোর্ড</Link>
          </li>
          <li className='text-blue-900 flex items-center my-1'>
            <IoMdArrowDropright className='text-green-700 text-2xl' />
            <Link href='https://emis.gov.bd/emis'>EMIS</Link>
          </li>
          <li className='text-blue-900 flex items-center my-1'>
            <IoMdArrowDropright className='text-green-700 text-2xl' />
            <Link href='https://banbeis.gov.bd/'>BANBEIS</Link>
          </li>
          <li className='text-blue-900 flex items-center my-1'>
            <IoMdArrowDropright className='text-green-700 text-2xl' />
            <Link href='https://hsp.pmeat.gov.bd/HSP-MIS/login'>উপবৃত্তি (HSP-MIS)</Link>
          </li>
        </ul>
      </div>
    </div>
