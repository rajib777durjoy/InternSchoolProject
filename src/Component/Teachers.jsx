                    ...
                    data.map((item, index) => <div key={index} className='border border-gray-300 rounded-md shadow-md p-4'>
                        ...
                        <div className='text-black mx-auto'>
                            ...
                            <div className='w-[30%] mx-auto'>
                                <button onClick={() => router.push(`/AllTeacher/${item?.id}`)} className='cursor-pointer text-center mx-auto bg-green-700 py-2 px-4 rounded-md text-white'>বিস্তারিত</button>
                            </div>
                        </div>
                    </div>)
                }
